...
acquire_credential_wrap(int argc, char **argv)
{
    ...
    struct getargs args[] = {
        ...
        { "source-app-identifier", 0, arg_string, NULL, NULL, "source app identifier for per app vpn" },
        { "source-app-audit-token", 0, arg_string, NULL, NULL, "file containing the audit token" },
        { "help", 'h', arg_flag, NULL, NULL, NULL }
    };
    int help_flag = 0;
    ...
    opt.source_app_identifier_string = NULL;
    opt.source_app_audit_token_string = NULL;
    ...
    args[7].value = &opt.source_app_identifier_string;
    args[8].value = &opt.source_app_audit_token_string;
    ...
    return ret;
usage:
    arg_printusage (args, 10, "acquire-credential", "[user name]");
    return 0;
}
...
destroy_wrap(int argc, char **argv)
{
    ...
    struct getargs args[] = {
        ...
        { "uuid", 0, arg_string, NULL, NULL, "cache entry" },
        { "help", 'h', arg_flag, NULL, NULL, NULL }
    };
    int help_flag = 0;
    ...
    return ret;
usage:
    arg_printusage (args, 5, "destroy", "[user name]");
    return 0;
}
...
static int
delete_all_wrap(int argc, char **argv)
{
    int ret;
    int optidx = 0;
    struct getargs args[] = {
    ...
    if(help_flag)
        goto usage;
    ret = delete_all(NULL, argc - optidx, argv + optidx);
    return ret;
usage:
    arg_printusage (args, 1, "delete-all", "alt-dsid");
    return 0;
}
...
SL_cmd commands[] = {
        ...
        { "delete-all", delete_all_wrap, "delete-all alt-dsid", "delete all the credentials for the supplied altdsid" },
