...
cms_verify_sd_wrap(int argc, char **argv)
{
    ...
    struct getargs args[] = {
        ...
        { "validate-certificate", 0, arg_negative_flag, NULL, "dont validate certificates", NULL },
        { "certificate-ku-check", 0, arg_negative_flag, NULL, "dont require correct Key Usage on certificate", NULL },
    ...
    opt.validate_certificate_flag = 1;
    opt.certificate_ku_check_flag = 1;
    ...
    args[8].value = &opt.validate_certificate_flag;
    args[9].value = &opt.certificate_ku_check_flag;
    args[10].value = &opt.signed_content_string;
    ...
    return ret;
usage:
    arg_printusage (args, 12, "cms-verify-sd", "in-file [out-file]");
    free_getarg_strings (&opt.anchors_strings);
    free_getarg_strings (&opt.certificate_strings);
    free_getarg_strings (&opt.pass_strings);
    return 0;
...
query_wrap(int argc, char **argv)
{
    ...
    struct getargs args[] = {
        ...
        { "persistent", 0, arg_string, NULL, "match on persistent identity", "persistent-identity" },
    ...
    args[3].value = &opt.persistent_string;
    args[4].value = &opt.eku_string;
    args[5].value = &opt.expr_string;
    args[6].value = &opt.keyEncipherment_flag;
    args[7].value = &opt.digitalSignature_flag;
    args[8].value = &opt.print_flag;
    args[9].value = &opt.pass_strings;
    ...
    return ret;
usage:
    arg_printusage (args, 11, "query", "certificates ...");
    free_getarg_strings (&opt.pass_strings);
    return 0;
}
