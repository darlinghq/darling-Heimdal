...
static const char *hc_error_strings[] = {
	...
	/* 004 */ N_("The caller is missing the required entitlement"),
	/* 005 */ N_("The requested command is unavailable on this platform"),
	/* 006 */ N_("Required value missing"),
	/* 007 */ N_("The requested attribute update is not allowed"),
	/* 008 */ NULL,
	/* 009 */ NULL,
	/* 010 */ NULL,
	/* 011 */ NULL,
