...
int    ASN1CALL decode_KRB5_PFS_GROUP(const unsigned char *, size_t, KRB5_PFS_GROUP *, size_t *);
int    ASN1CALL encode_KRB5_PFS_GROUP(unsigned char *, size_t, const KRB5_PFS_GROUP *, size_t *);
size_t ASN1CALL length_KRB5_PFS_GROUP(const KRB5_PFS_GROUP *);
int    ASN1CALL copy_KRB5_PFS_GROUP  (const KRB5_PFS_GROUP *, KRB5_PFS_GROUP *);
void   ASN1CALL free_KRB5_PFS_GROUP  (KRB5_PFS_GROUP *);
